...
<div class="row">
		<?php
echo $form->label($model, 'departmentId');
?>
		<?php
echo $form->textField($model, 'departmentId');
?>
	</div>
...
<div class="row">
		<?php
echo $form->label($model, 'ext');
?>
		<?php
echo $form->textField($model, 'ext');
?>
	</div>

<div class="row">
		<?php
echo $form->label($model, 'hireDate');
?>
		<?php
echo $form->textField($model, 'hireDate');
?>
	</div>

<div class="row">
		<?php
echo $form->label($model, 'leaveDate');
?>
		<?php
echo $form->textField($model, 'leaveDate');
?>
	</div>
